...
import debugFundBtcAddressRoutes from './app/api/debug/fund-btc-address+api';
import debugSetAutoFundPreferenceRoutes from './app/api/debug/set-auto-fund-preference+api';
...
apiRouter.use('/debug/fund-btc-address', debugFundBtcAddressRoutes);
apiRouter.use('/debug/set-auto-fund-preference', debugSetAutoFundPreferenceRoutes);
